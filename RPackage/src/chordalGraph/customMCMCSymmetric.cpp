...
SEXP customMCMCSymmetric(SEXP nVertices_sexp, SEXP approximateCounts_sexp, SEXP seed_sexp, SEXP burnIn_sexp, SEXP runSize_sexp)
{
BEGIN_RCPP
	int nVertices;
	try
	...
	chordalGraph::customMCMCSymmetric(args);
