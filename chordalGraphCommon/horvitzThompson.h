...
namespace chordalGraph
{
	enum samplingType
	{
		sampfordSamplingMultinomial, conditionalPoissonSampling, paretoSampling, semiDeterministicSampling, sampfordSamplingConditionalPoisson, sampfordFromParetoNaive
	};
