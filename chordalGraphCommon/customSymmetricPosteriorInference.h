#ifndef CUSTOM_SYMMETRIC_POSTERIOR_INFERENCE_HEADER_GUARD
#define CUSTOM_SYMMETRIC_POSTERIOR_INFERENCE_HEADER_GUARD
...
{
	struct workingCustomSymmetricPosteriorInference
	{
	public:
	...
	struct customSymmetricPosteriorInferenceArgs
	{
		...
		customSymmetricPosteriorInferenceArgs()
