#ifndef ARMSTRONG_POSTERIOR_INFERENCE_HEADER_GUARD
#define ARMSTRONG_POSTERIOR_INFERENCE_HEADER_GUARD
...
{
	struct workingArmstrongPosteriorInference
	{
	public:
		workingArmstrongPosteriorInference(int nVertices)
	...
	struct armstrongPosteriorInferenceArgs
	{
